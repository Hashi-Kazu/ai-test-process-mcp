...
export const testTechniqueToolMapping: { techniqueId: TestTechniqueId; toolName: string }[] = [
  ...
  { techniqueId: "error-guessing", toolName: "generate_test_cases" },
  { techniqueId: "exploratory", toolName: "generate_test_cases" },
  { techniqueId: "checklist-based", toolName: "generate_test_cases" },
